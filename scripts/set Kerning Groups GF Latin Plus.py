...
DefaultKeys = {
	...
	"periodcentered" :  ["hyphen", "hyphen"],
	"bullet" :  ["hyphen", "hyphen"],
	"colon" :  ["period", "period"],
	"comma" :  ["period", "period"],
	"ellipsis" :  ["period", "period"],
	"exclam" :  ["exclam", "exclam"],
	"exclamdown" :  ["exclam", "exclam"],
	"numbersign" :  ["numbersign", "numbersign"],
	"period" :  ["period", "period"],
	"question" :  ["quesion", "question"],
	"questiondown" :  ["questiondown", "questiondown"],
	"quotedbl" :  ["quotesingle", "quotesingle"],
	"quotesingle" :  ["quotesingle", "quotesingle"],
	"semicolon" :  ["period", "period"],
	"slash" :  ["slash", "slash"],
	"underscore" :  ["period", "period"],
	"periodcentered.loclCAT" :  ["period", "period"],
	"braceleft" :  ["parenleft", "parenleft"],
	"braceright" :  ["parenright", "parenright"],
	"bracketleft" :  ["parenleft", "parenleft"],
	"bracketright" :  ["parenright", "parenright"],
	"parenleft" :  ["parenleft", "parenleft"],
	"parenright" :  ["parenright", "parenright"],
	"braceleft.case" :  ["parenleft", "parenleft"],
	"braceright.case" :  ["parenright", "parenright"],
	"bracketleft.case" :  ["parenleft", "parenleft"],
	"bracketright.case" :  ["parenright", "parenright"],
	"parenleft.case" :  ["parenleft", "parenleft"],
	...
	"guilsinglright" :  ["guilsinglright", "guilsinglright"],
	...
	"peso" :  ["Hbar", "P"],
	"ruble" :  ["Hbar", "P"],
	"rupeeIndian" :  ["H", "rupeeIndian"],
	"sterling" :  ["sterling", "sterling"],
	"won" :  ["V", "V"],
	"yen" :  ["Y", "Y"],
	"bulletoperator" :  ["hyphen", "hyphen"],
	"divisionslash" :  ["slash", "slash"],
	"plus" :  ["plus", "plus"],
	"minus" :  ["plus", "plus"],
	"multiply" :  ["plus", "plus"],
	"divide" :  ["plus", "plus"],
	...
	"greater" :  ["plus", "plus"],
	"less" :  ["plus", "plus"],
	"greaterequal" :  ["plus", "plus"],
	"lessequal" :  ["plus", "plus"],
	"plusminus" :  ["plus", "plus"],
	"approxequal" :  ["plus", "plus"],
	"asciitilde" :  ["plus", "plus"],
	"logicalnot" :  ["plus", "plus"],
	"micro" :  ["u", "micro"],
	...
	"copyright" :  ["O", "O"],
	"registered" :  ["O", "O"],
	"trademark" :  ["ordfeminine", "ordfeminine"],
	"degree" :  ["ordfeminine", "ordfeminine"],
	"bar" :  ["H", "H"],
	"brokenbar" :  ["H", "H"],
	"dagger" :  ["Hbar", "Hbar"],
	"daggerdbl" :  ["Hbar", "Hbar"],
	"numero" :  ["H", "ordfeminine"],
	"asciicircum" :  ["asterisk", "asterisk"],
	"one" : ["one", "one"],
	"two" : ["two", "two"],
	"three" : ["three", "three"],
	"four" : ["four", "four"],
	...
	"one.lf" : ["one", "one"],
	"two.lf" : ["two", "two"],
	"three.lf" : ["three", "three"],
	"four.lf" : ["four", "four"],
	"five.lf" : ["five", "five"],
	"six.lf" : ["six", "six"],
	"seven.lf" : ["seven", "seven"],
	"eight.lf" : ["eight", "eight"],
	"nine.lf" : ["nine", "nine"],
	"ten.lf" : ["ten", "ten"],
	"one.osf" : ["one", "one"],
	"two.osf" : ["two", "two"],
	"three.osf" : ["three", "three"],
	"four.osf" : ["four", "four"],
	"five.osf" : ["five", "five"],
	"six.osf" : ["six", "six"],
	"seven.osf" : ["seven", "seven"],
